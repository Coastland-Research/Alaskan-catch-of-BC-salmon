...
```{r,fig.height=8,fig.cap="Alaskan exploitation rates on Skeena sockeye by CU."}
...
```{r fig-nass-trtc2,fig.cap="Alaskan exploitation on Nass sockeye. Boxplot."}
ggplot(data,aes(x=`AK ER`,y=reorder(CU_Name,`AK ER`,median),fill=CU_Name))+
  geom_boxplot(outlier.shape = NA) +
  geom_jitter(height=.1)+
  labs(y="Conservation Unit",x="Alaskan Exploitation Rate")+
