...
source("R/coho_seak_cdn_ers.R")
source("R/coho-seak-er-cu.R")
source("R/coho_zolzap_ers.R")
```
...
source("R/chum_seak_harvest.R")
source("R/chum_seak_bydistrict.R")
source("R/chum_seak_cdn_ers_sa.R")
source("R/chum_seak_er_bycu.R")
```

```{r chum data}
harv<-fread("data-raw/ADFG AK Harvest and Vaue 1980 2022.csv")
...
source("R/pink_seak_harv.R")
source("R/pink_seak_harv_dist.R")
source("R/pinkeven_ers_sa.R")
source("R/pinkodd_ers_sa.R")
source("R/pink_seak_er_cu.R")
```
